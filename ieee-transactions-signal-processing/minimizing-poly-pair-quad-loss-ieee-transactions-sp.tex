...
\title{On Minimizing Polynomial Pair Conjugacy Loss for Steerable Near-quadrature 3D Filters}
%
%
...
\author{ Tommy M. Tang,
        Jose L. Vilas-Prieto,
        and Hemant D. Tagare % <-this % stops a space
...
\begin{IEEEkeywords}
steerability \and quadrature \and filter \and quadratic programming \and hilbert matrices
\end{IEEEkeywords}
...
\IEEEPARstart{A}{nalytic} signals provide a powerful framework for the extraction of local properties of signals. Quadrature filters that give Hilbert transforms of signals are essential to these calculations, and several methods have been proposed to extend the Hilbert transform to higher dimensions \cite{boukerroui2004choice}. Of these, methods for two-dimensional signal via the use of steerable filters to combine information about images at various orientations have been proposed to preserve the isotropy property, necessary to obtain invariance of the measure of the impulse of the local signal under rotation. \\
...
\subsubsection{Generalization of the Hilbert Transform}
Subsubsection text here.

\subsubsection{Three-dimensional Axially Symmetric Steerable Filters}

\subsubsection{Optimization Problem}

\section{Results} 
\subsection{Solution to Quadratic Minimization}

\subsection{Properties of Generalized Hilbert Matrix Inverse and Notation}

\subsection{Theorem on Behavior of Minimal Solution}
